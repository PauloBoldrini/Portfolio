...
var
	// usa o documento correto de acordo com o argumento da janela (sandbox)
	document = window.document,

	version = "2.1.1",

	// Define o local de cópia do jQuery
	jQuery = function( selector, context ) {
		return new jQuery.fn.init( selector, context );
	},

	// Para Support: Android<4.1
	rtrim = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,

	// Corresponde a string tracejada
	rmsPrefix = /^-ms-/,
	rdashAlpha = /-([\da-z])/gi,

	// jQuery.camelCase as callback to replace()
...
jQuery.fn = jQuery.prototype = {
	...
	// Começar com um seletor vazio
	selector: "",

	// Comprimento padrão é 0
	length: 0,
...
// (retornando o novo conjunto de elementos correspondentes) 
	pushStack: function( elems ) {
		...
		// Construido um novo conjunto de elementos correspondentes do jQuery 
...
// (Você pode semear os argumentos com uma matriz de args, mas isso é
		...
		if ( (options = arguments[ i ]) != null ) {
			...
			for ( name in options ) {
				...
				if ( deep && copy && ( jQuery.isPlainObject(copy) || (copyIsArray = jQuery.isArray(copy)) ) ) {
					...
					// Evitar a remoção, utilizado clonagem
...
jQuery.extend({
	...
	// Resultados apenas para uso interno
